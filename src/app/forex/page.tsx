...
export default function ForexPage() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <header>
        <h1 className="text-2xl sm:text-3xl font-bold text-white mb-1">Forex Market</h1>
        <p className="text-sm sm:text-base text-[color:var(--color-text-muted)]">
          Chart analysis and signal detection for currency pairs
        </p>
      </header>
      ...
      <SymbolSearch assetType="forex" currentSymbol={symbol} onSelect={handleSelect} />
