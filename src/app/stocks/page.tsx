...
export default function StocksPage() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <header>
        <h1 className="text-2xl sm:text-3xl font-bold text-white mb-1">Stock Analysis</h1>
        <p className="text-sm sm:text-base text-[color:var(--color-text-muted)]">
          Chart analysis and signal detection for equities
        </p>
      </header>
      ...
      <SymbolSearch assetType="stocks" currentSymbol={symbol} onSelect={handleSelect} />
